...
# Вариант 27: Интернет-магазин
# Таблица "Продажи": ФИО покупателя, товар, единица измерения (штуки, кг, л),
# количество, стоимость.
# Функционал: ввод (10 записей), поиск, удаление, редактирование.
# По 3 разных SQL-запроса на каждую операцию.
# """
...
#         """, sample_data)
#         conn.commit()
#         print(f"Добавлено {INITIAL_RECORDS} начальных записей.")
#     conn.close()
